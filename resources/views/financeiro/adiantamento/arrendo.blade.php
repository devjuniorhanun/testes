...
@for($i=1;$i<=2;$i++) <div class="row mb-5 recibos">
    <div class="col border rounded">
        ...
        <div class="row pt-2">
            <div class="col border rounded">
                Referente a: <b>Pagamento de Parceria de Arrendo. {{ $entry->safra->nome}} </b>
            </div>
        </div>
        ...
        <div class="row pt-2">
            ...
            <div class="col col-md-2 border rounded">
                ...
                <div class="row">
                    <div class="col numeroRecibo">{{ (isset($entry->nome_banco))? $entry->nome_banco : $entry->fornecedor->nome_banco }}</div>
                </div>
            ...
            <div class="col col-md-2 border rounded">
                ...
                <div class="row">
                <div class="col numeroRecibo">{{ (isset($entry->agencia))? $entry->agencia : $entry->fornecedor->agencia }}</div>
                </div>
            </div>
            <div class="col col-md-2 border rounded">
                <div class="row">
                ...
                <div class="row">
                    <div class="col numeroRecibo">{{ (isset($entry->num_conta))? $entry->num_conta : $entry->fornecedor->num_conta }}</div>
                </div>
            </div>
            <div class="col col-md-2 border rounded">
                <div class="row">
                ...
                <div class="row">
                    <div class="col numeroRecibo">{{ (isset($entry->num_cheque))? $entry->num_cheque : '' }}</div>
                </div>
            </div>
