...
--
-- Host: localhost:3306
-- Tempo de geração: 06/01/2021 às 17:09
...
CREATE TABLE `fornecedors` (
  ...
  `cpf_cnpj` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `rg_inscricao` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
